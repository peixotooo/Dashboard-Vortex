...
const TYPE_SYNONYMS: Record<string, string[]> = {
  ...
  neutro: ["basic", "liso"],
  neutra: ["basic", "liso"],
  // Linha feminina da Bulking = SEAMLESS SIGNATURE (legging/short/top/macaquinho,
  // várias cores). Não há tag "feminino" pesquisável, então mapeia os termos de
  // gênero pros marcadores da linha (seamless/legging/macaquinho) — assim
  // "produtos femininos" traz a coleção feminina inteira, não os básicos masc.
  feminino: ["seamless", "legging", "macaquinho"],
  feminina: ["seamless", "legging", "macaquinho"],
  femininos: ["seamless", "legging", "macaquinho"],
  femininas: ["seamless", "legging", "macaquinho"],
  mulher: ["seamless", "legging", "macaquinho"],
  mulheres: ["seamless", "legging", "macaquinho"],
  menina: ["seamless", "legging", "macaquinho"],
  fitness: ["seamless", "legging", "top"],
  legging: ["legging", "calca", "seamless"],
  macaquinho: ["macaquinho", "seamless"],
  seamless: ["seamless", "legging", "macaquinho", "top", "short"],
