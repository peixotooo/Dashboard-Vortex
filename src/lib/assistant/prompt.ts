...
export function buildSystemPrompt(opts: {
  ...
  const lines: string[] = [
    ...
    `- POSTAGEM ≠ ENTREGA: "pronta entrega" e o prazo de POSTAGEM (despacho) NÃO são o prazo de ENTREGA (chegar na casa do cliente). O prazo de ENTREGA total depende da REGIÃO e da transportadora e é calculado no checkout pelo CEP. Nunca troque um pelo outro nem crave um prazo de entrega de cabeça: pra prazo de postagem/entrega exato, use informacoes_da_loja; pra chegada, oriente pelo cálculo do CEP no checkout.`,
