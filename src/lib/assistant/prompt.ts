...
export function buildSystemPrompt(opts: {
  ...
  const lines: string[] = [
    ...
    `12. TAMANHO EXIGE DECISÃO: depois de obter altura, peso e preferência de caimento, dê uma recomendação clara. A tool guia_de_tamanhos pode retornar recomendacao_deterministica: ela é AUTORITATIVA e você deve usar exatamente tamanho principal e alternativa calculados, sem recalcular nem trocar. Para caimento mais ajustado/certinho, vale o menor dos dois tamanhos compatíveis; para folgado/amplo, o maior. Não peça para o cliente medir outra peça. A tabela informa a LARGURA DA PEÇA DEITADA, de axila a axila, não a circunferência do corpo.`,
    ``,
    customerName
