...
//
// Proxies GET /accounts/{accountId}/contact_imports/{id} so the client
// can poll bulk-import status without exposing the workspace's Locaweb
// token to the browser. Normalizes the status label to processing /
// finished / error so the UI doesn't string-compare PT-BR.
