...
import { DemandCard } from "@/components/team/mission-control/demand-card";
import { DemandForm } from "@/components/team/mission-control/demand-form";
import type { Demand, DemandStatus } from "@/lib/team/mission-control/types";
import { AREAS, PRIORITIES } from "@/lib/team/mission-control/types";
import { AREA_LABEL } from "@/lib/team/mission-control/format";
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <Link
            href="/team/mission-control/reports"
            className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground"
          >
          ...
          <Link
            href="/team/mission-control/learnings"
            className="inline-flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground"
          >
